class Car{
    ...
    {
        const points = [];
        const rad = Math.hypot(this.width,this.height)/2;// distance form the center of the car to the corner
        const alpha = Math.atan2(this.width,this.height);//gives the angle for the point formation in the array
        points.push({
    ...
    draw(carCtx,color,drawSensor = false)
    {
        if(this.damaged)
        {
